...
<div class="home">
    ...
    <section class="home__wrapper">
        ...
        <section class="container home__section">
            ...
            <div v-show="this.showingBeer">
                @if ($beer_pdf->id ?? false)
                    <div class="row">
                        <a href="{{ $beer_pdf->getUrl() }}" target="_blank">PDF Menu</a>
                    </div>
                @endif
        ...
        {{-- 3 Icon Section --}}
        <section class="home__section home__section--grey">
            <div class="container">
                <div class="row">
                    <div class="col-md-4 home__icon">
                        ...
                        <div class="home__icon-content">
                            <strong>M-Thurs:</strong> 11am-11pm<br>
        ...
        {{-- Contact Form --}}
        <section class="home__section" id="contact-form">
        ...
        <section class="home__section home__section--grey">
            <div class="container col-md-6">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="row">
                            <img class="img img-responsive mx-auto" src="{{ asset('img/planks-historic.jpg') }}" />
                        </div>
                    </div>
                    <div class="col-md-8">
                        <p>
